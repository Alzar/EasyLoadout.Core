...
namespace EasyLoadout.Core.Utils {
	...
	public static class LoadoutHandler {

		//Function for LSPDFR Plugin To Call To Actually Allow The Plugin To Work Without Crashing
		public static void LSPDFRLoadout(bool OnDuty) {
			Core.Setup(true, OnDuty);
			GiveLoadout();
		}
